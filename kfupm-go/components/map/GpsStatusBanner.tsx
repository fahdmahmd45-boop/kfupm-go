...
export default function GpsStatusBanner({ state, onRetry }: { state: GeolocationState; onRetry: () => void }) {
  ...
  if (state.status === "loading") {
    return (
      <div className="flex items-center gap-2 rounded-xl bg-white/95 px-3.5 py-2.5 text-xs font-medium text-neutral-600 shadow-md ring-1 ring-black/5 backdrop-blur">
  ...
  if (state.status === "denied") {
    return (
      <div className="flex items-center gap-2 rounded-xl bg-amber-50 px-3.5 py-2.5 text-xs font-medium text-amber-800 shadow-md ring-1 ring-amber-200/60">
  ...
  return (
    <div className="flex items-center gap-2 rounded-xl bg-red-50 px-3.5 py-2.5 text-xs font-medium text-red-700 shadow-md ring-1 ring-red-200/60">
